    ...
    class CPU8086 : public Component
    {
        ...
        private: 
            ...
            static constexpr CPU8086Instruction instruction_table[CPU8086_NUM_OPCODES] =
            {
                ...
                { 0x88, Op_MovModRM, 2, 1 }, { 0x89, Op_MovModRM, 2, 1 }, { 0x8A, Op_MovModRM, 2, 1 },  { 0x8B, Op_MovModRM, 2, 1 },  { 0x8C, Op_MovRegToSeg, 2, 1 }, { 0x8D, Op_Lea, 3, 1 }, { 0x8E, Op_MovRegToSeg, 2, 1 },  { 0x8F, Op_PopModRM, 2, 1 }, 
            ...
            static constexpr const char* grp1_table_disasm[CPU8086_NUM_OPCODES_PER_GRP] = {"ADD", "OR", "ADC", "SBB", "AND", "SUB", "XOR", "CMP"};
