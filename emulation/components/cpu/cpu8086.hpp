    ...
    class CPU8086 : public Component
    {
        ...
        private: 
            ...
            static constexpr CPU8086Instruction instruction_table[CPU8086_NUM_OPCODES] =
            {
                ...
                { 0xB8, Op_Nop, 1, 1 }, { 0xB9, Op_Nop, 1, 1 }, { 0xBA, Op_Nop, 1, 1 },  { 0xBB, Op_Nop, 1, 1 },  { 0xBC, Op_Nop, 1, 1 }, { 0xBD, Op_Nop, 1, 1 }, { 0xBE, Op_Nop, 1, 1 },  { 0xBF, Op_Nop, 1, 1 }, 
                { 0xC0, Op_Nop, 1, 1 }, { 0xC1, Op_Nop, 1, 1 }, { 0xC2, Op_Nop, 1, 1 },  { 0xC3, Op_Nop, 1, 1 },  { 0xC4, Op_Nop, 1, 1 }, { 0xC5, Op_Nop, 1, 1 }, { 0xC6, Op_Nop, 1, 1 },  { 0xC7, Op_Nop, 1, 1 }, 
                { 0xC8, Op_Nop, 1, 1 }, { 0xC9, Op_Nop, 1, 1 }, { 0xCA, Op_Nop, 1, 1 },  { 0xCB, Op_Nop, 1, 1 },  { 0xCC, Op_Nop, 1, 1 }, { 0xCD, Op_Nop, 1, 1 }, { 0xCE, Op_Nop, 1, 1 },  { 0xCF, Op_Nop, 1, 1 }, 
